...
& $python -m PyInstaller --noconfirm --clean --onefile --windowed @iconArgs --name "BLACKBOX" "blackbox_desktop.pyw"

if (-not (Test-Path "dist\BLACKBOX.exe")) { throw "Build did not create dist\BLACKBOX.exe" }
